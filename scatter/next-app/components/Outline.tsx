...
const Section = ({
  ...
  const handleClick = () => {
    ...
    if (elem) {
      ...
      window.scrollTo({
        top: elemPosition - headerHeight - 20,
        behavior: "smooth",
      });
    }
  };
...
const Outline = ({ clusters, translator }: Props) => {
  ...
  return (
    <div
      className="hidden xl:block fixed left-0 top-0 h-full text-left mt-8 opacity-40 hover:opacity-100 leading-10 transition-all"
